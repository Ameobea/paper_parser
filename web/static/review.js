...
$(document).ready(function(){
  $.get("http://ip.ameobea.me:5000/data/results.json", function(parsedJson){
    parsedJson.forEach(function(page){
      ...
      mainTable.append("<tr id='" + page.document + page.page + "'><td>" + page.document + "</td><td><a href='http://ip.ameobea.me:5000/data/raw/" + page.document + "+page-" + page.page + ".txt'>" + page.page + "</a></td>");
      for(var key in page){
